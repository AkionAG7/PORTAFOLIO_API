...
@router.patch("/{language_id}", response_model=MessageResponseDTO)
...
@router.patch("/{language_id}/status", response_model=MessageResponseDTO)
...
@router.patch("/user/{user_id}/{language_id}/status", response_model=MessageResponseDTO)
...
@router.patch("/user/{user_id}/{language_id}", response_model=MessageResponseDTO)
